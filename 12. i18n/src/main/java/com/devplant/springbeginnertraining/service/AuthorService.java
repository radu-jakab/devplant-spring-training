...
import com.devplant.springbeginnertraining.validators.AuthorValidator;
...
public class AuthorService {
	...
	public Author create(Author author) {
		...
		if (authorRepo.exists(author.getId()))
			throw new IllegalArgumentException(messages.getMessage("author.error.alreadyExists", author.getId()));
